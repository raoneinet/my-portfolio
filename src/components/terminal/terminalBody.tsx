...
export default function TerminalBody() {
    ...
    return (
        <div className="md:w-[340px] w-[300px] h-fit rounded-xl overflow-hidden bg-[#0f0f1a] border border-white/[0.08] font-mono text-xs shadow-[0_24px_80px_rgba(0,0,0,0.5)]">
